...
export class InitialSchema1788941201732 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_beer_entry" ADD CONSTRAINT "FK_68a3a56d35a54eacf93b3166f19" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "review_like" ADD CONSTRAINT "FK_f586f7a08d5ea44e409e61e8de5" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "review_like" ADD CONSTRAINT "FK_cf9251ae2c2598692d5007cbd0b" FOREIGN KEY ("reviewId") REFERENCES "review"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
